...
import com.example.mvvmrunningapp.other.Constants.TIME_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private val timeRunningInSeconds = MutableLiveData<Long>()
    ...
    private fun postInitialValue(){
        ...
        timeRunningInSeconds.postValue(0L)
    ...
    private fun startTimer()
    {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!)
            {
                ...
                {
                    timeRunningInSeconds.postValue(timeRunningInSeconds.value!! + 1)
    ...
    private fun startForegroundService() {
        ...
        timeRunningInSeconds.observe(this, Observer {
            if (!serviceKilled)
            {
